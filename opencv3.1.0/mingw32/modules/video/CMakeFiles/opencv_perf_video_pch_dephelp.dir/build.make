...
modules/video/opencv_perf_video_pch_dephelp.cxx: H:/seawave/opencv/sources/modules/video/perf/perf_precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=H:\seawave\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_perf_video_pch_dephelp.cxx"
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo #include \"H:/seawave/opencv/sources/modules/video/perf/perf_precomp.hpp\" > H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo "int testfunction();" >> H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo "int testfunction()" >> H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo { >> H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo "    return 0;" >> H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
	cd /d H:\seawave\build\modules\video && G:\cmake\bin\cmake.exe -E echo } >> H:/seawave/build/modules/video/opencv_perf_video_pch_dephelp.cxx
...
modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/opencv_perf_video_pch_dephelp.cxx.obj: modules/video/opencv_perf_video_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=H:\seawave\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/opencv_perf_video_pch_dephelp.cxx.obj"
	cd /d H:\seawave\build\modules\video && G:\qt5.5.1\Tools\mingw492_32\bin\g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\opencv_perf_video_pch_dephelp.dir\opencv_perf_video_pch_dephelp.cxx.obj -c H:\seawave\build\modules\video\opencv_perf_video_pch_dephelp.cxx
...
modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/opencv_perf_video_pch_dephelp.cxx.i: cmake_force
	...
	cd /d H:\seawave\build\modules\video && G:\qt5.5.1\Tools\mingw492_32\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E H:\seawave\build\modules\video\opencv_perf_video_pch_dephelp.cxx > CMakeFiles\opencv_perf_video_pch_dephelp.dir\opencv_perf_video_pch_dephelp.cxx.i
...
modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/opencv_perf_video_pch_dephelp.cxx.s: cmake_force
	...
	cd /d H:\seawave\build\modules\video && G:\qt5.5.1\Tools\mingw492_32\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S H:\seawave\build\modules\video\opencv_perf_video_pch_dephelp.cxx -o CMakeFiles\opencv_perf_video_pch_dephelp.dir\opencv_perf_video_pch_dephelp.cxx.s
...
lib/libopencv_perf_video_pch_dephelp.a: modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=H:\seawave\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ..\..\lib\libopencv_perf_video_pch_dephelp.a"
	cd /d H:\seawave\build\modules\video && $(CMAKE_COMMAND) -P CMakeFiles\opencv_perf_video_pch_dephelp.dir\cmake_clean_target.cmake
	cd /d H:\seawave\build\modules\video && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\opencv_perf_video_pch_dephelp.dir\link.txt --verbose=$(VERBOSE)
...
modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/clean:
	cd /d H:\seawave\build\modules\video && $(CMAKE_COMMAND) -P CMakeFiles\opencv_perf_video_pch_dephelp.dir\cmake_clean.cmake
...
modules/video/CMakeFiles/opencv_perf_video_pch_dephelp.dir/depend: modules/video/opencv_perf_video_pch_dephelp.cxx
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" H:\seawave\opencv\sources H:\seawave\opencv\sources\modules\video H:\seawave\build H:\seawave\build\modules\video H:\seawave\build\modules\video\CMakeFiles\opencv_perf_video_pch_dephelp.dir\DependInfo.cmake --color=$(COLOR)
