...
#define _OSD_WEEK3            (_OSD_BASE+5)        /*show week time in English: MONблSUN*/
#define    _OSD_CWEEK1            (_OSD_BASE+6)        /*show week time in Chinese GB code*/
#define    _OSD_HOUR24            (_OSD_BASE+7)        /*show 24 hours clock: 00бл23    */
#define    _OSD_HOUR12            (_OSD_BASE+8)        /*show 12 hours clock: 00бл12*/
#define    _OSD_MINUTE            (_OSD_BASE+9)        /*show minute time by length of 2: 00бл59*/
#define _OSD_SECOND            (_OSD_BASE+10)        /*show second time by length of 2: 00бл59*/
